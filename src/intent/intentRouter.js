...
export async function routeIntent(userDocId, text, media = {}) {
  ...
  if (
    ...
    if (campo === "data") return "📅 Digite a nova data (ex: 25/03):";
  ...
  if (
    ...
    // 🚨 PROTEÇÃO FINAL (NUNCA MAIS VAI DAR ERRO)
    if (Object.keys(update).length === 0) {
      return "⚠️ Não consegui atualizar. Tente novamente.";
    }
  ...
  try {
    ...
    ===================================================== */
        ...
        if (item.tipo === "gasto") {
          ...
          batch.set(ref, {
            valor,
            local: item.descricao || "Local não informado",
            categoria,
            timestamp,
